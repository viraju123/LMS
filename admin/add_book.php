...
<?php
	if(isset($_POST['add_book'])){
    	...
    	$db = mysqli_select_db($connection,"lms");
     	$query = "insert into books values('','$_POST[book_name]','$_POST[book_author]','$_POST[book_cat]','$_POST[book_price]','$_POST[book_quantity]')";
    	$query_run = mysqli_query($connection,$query);
	
       	$q1= mysqli_query($connection,"select author_name from authors where author_name='$_POST[book_author]'");
     	if(mysqli_num_rows($q1)==0)
    	{
	   	...
	   	$q2= mysqli_query($connection,"select cat_name from category where cat_name='$_POST[book_cat]'");
