	...
	if(isset($_POST['submit']))
	{
	  ...
	  if(mysqli_num_rows($q)==0)
	  ...
	  else
	    {
	     ...
	     echo " <td>   ";                               
	     echo (' <button class="btn" name=""><a href="edit_book.php?bn='); echo" $row[book_id]"; echo('">Edit</a></button >');
	     echo (' <button class="btn" name=""><a href="delete_book.php?bn=');  echo" $row[book_id]"; echo('">Delete</a></button>');
	      echo "</td>";
	      echo "</tr>";
	      }
	      echo "</table>";
