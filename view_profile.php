		...
		<div class="col-md-4">
			<form>
				<div class="form-group">
					<label>Name:</label>
					<input type="text" class="form-control" value="<?php echo $name;?>" disabled><!--cant be edited-->
				</div>
				<div class="form-group">
					<label>Email:</label>
				...
				<div class="form-group">
					<label>Address:</label>
					<textarea rows="3" cols="20" disabled="" class="form-control"><?php echo $address;?></textarea>
				</div>
			</form>
		</div>
		<div class="col-md-4"></div>
